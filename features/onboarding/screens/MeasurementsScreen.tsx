      ...
      >
        ...
        <View style={styles.measurementContent}>
          <Typography
            ...
            weight="medium"
            style={{
              color: focused || hasValue ? color : colors.textMuted,
          ...
          <View style={styles.inputRow}>
            ...
            <Typography
              variant="body1"
              weight="semibold"
              style={{ color: focused || hasValue ? color : colors.textMuted }}
            >
              {unit}
            </Typography>
          </View>
...
export default function MeasurementsScreen() {
  ...
  const [focusedField, setFocusedField] = useState<"height" | "weight" | null>(
    null
  );
  ...
  const canContinue = heightCm && heightCm > 0 && weightKg && weightKg > 0;
              ...
              <MeasurementCard
                icon={
                  <Ruler
                    size={24}
                    color={
                      focusedField === "height" || heightValue
                        ? "#10B981"
                        : colors.textMuted
                    }
                  />
              ...
              <MeasurementCard
                icon={
                  <Weight
                    size={24}
                    color={
                      focusedField === "weight" || weightValue
                        ? "#F59E0B"
                        : colors.textMuted
                    }
                  />
