...
export const ExerciseOptionsSheetV2 = ({
  visible,
  exerciseName,
  ...
  const options: ActionOption[] = [
    {
      ...
      description: t.replaceDesc[lang],
    ...
    },
    {
      ...
      label: t.createSuperset[lang],
      description: t.createSupersetDesc[lang],
      color: "#10b981",
      onPress: () => {
        onClose();
        onCreateSuperset?.();
      },
      show: !isInMultiBlock && !!onCreateSuperset,
    },
    {
      id: "delete",
