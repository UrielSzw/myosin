    ...
    await db.transaction(async (tx) => {
        ...
        if (existing) {
          ...
          await tx
            ...
            .set({
              ...
              best_primary_value: prData.best_primary_value,
              best_secondary_value: prData.best_secondary_value,
      ...
      for (const historyData of prHistoryData) {
        await tx.insert(pr_history).values({
          ...
          measurement_template: historyData.measurement_template,
          primary_value: historyData.primary_value,
          secondary_value: historyData.secondary_value,
          pr_score: historyData.pr_score,
