...
export const SessionEmptyStateV2: React.FC<Props> = ({
  ...
  const isNoSessions = variant === "no-sessions";
  const Icon = isNoSessions ? Calendar : Search;
  const iconColor = isNoSessions ? colors.primary[500] : colors.primary[500];
