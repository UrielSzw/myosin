CREATE TABLE `sync_engine_state` (
	...
	`backoff_until` text,
	`network_state` text DEFAULT 'offline' NOT NULL,
	`last_network_change` text,
...
CREATE INDEX `sync_queue_scheduled_idx` ON `sync_queue` (`scheduled_at`);--> statement-breakpoint
CREATE INDEX `sync_queue_created_idx` ON `sync_queue` (`created_at`);--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_pr_current`("id", "user_id", "exercise_id", "best_weight", "best_reps", "estimated_1rm", "achieved_at", "source", "created_at", "updated_at") SELECT "id", "user_id", "exercise_id", "best_weight", "best_reps", "estimated_1rm", "achieved_at", "source", "created_at", "updated_at" FROM `pr_current`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_pr_history`("id", "user_id", "exercise_id", "weight", "reps", "estimated_1rm", "workout_session_id", "workout_set_id", "source", "created_at", "updated_at") SELECT "id", "user_id", "exercise_id", "weight", "reps", "estimated_1rm", "workout_session_id", "workout_set_id", "source", "created_at", "updated_at" FROM `pr_history`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_exercise_in_block`("id", "user_id", "block_id", "exercise_id", "order_index", "notes", "created_at", "updated_at") SELECT "id", "user_id", "block_id", "exercise_id", "order_index", "notes", "created_at", "updated_at" FROM `exercise_in_block`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_exercises`("id", "name", "source", "created_by_user_id", "main_muscle_group", "primary_equipment", "exercise_type", "secondary_muscle_groups", "instructions", "equipment", "similar_exercises", "default_measurement_template", "created_at", "updated_at") SELECT "id", "name", "source", "created_by_user_id", "main_muscle_group", "primary_equipment", "exercise_type", "secondary_muscle_groups", "instructions", "equipment", "similar_exercises", "default_measurement_template", "created_at", "updated_at" FROM `exercises`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_folders`("id", "name", "color", "icon", "order_index", "created_by_user_id", "created_at", "updated_at") SELECT "id", "name", "color", "icon", "order_index", "created_by_user_id", "created_at", "updated_at" FROM `folders`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_routine_blocks`("id", "user_id", "routine_id", "type", "order_index", "rest_time_seconds", "rest_between_exercises_seconds", "name", "created_at", "updated_at") SELECT "id", "user_id", "routine_id", "type", "order_index", "rest_time_seconds", "rest_between_exercises_seconds", "name", "created_at", "updated_at" FROM `routine_blocks`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_routine_sets`("id", "user_id", "exercise_in_block_id", "measurement_template", "primary_value", "secondary_value", "primary_range", "secondary_range", "rpe", "tempo", "order_index", "set_type", "created_at", "updated_at") SELECT "id", "user_id", "exercise_in_block_id", "measurement_template", "primary_value", "secondary_value", "primary_range", "secondary_range", "rpe", "tempo", "order_index", "set_type", "created_at", "updated_at" FROM `routine_sets`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_routines`("id", "name", "folder_id", "created_by_user_id", "training_days", "show_rpe", "show_tempo", "created_at", "updated_at") SELECT "id", "name", "folder_id", "created_by_user_id", "training_days", "show_rpe", "show_tempo", "created_at", "updated_at" FROM `routines`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_tracker_daily_aggregates`("id", "user_id", "metric_id", "day_key", "sum_normalized", "count", "min_normalized", "max_normalized", "avg_normalized", "previous_day_sum", "created_at", "updated_at") SELECT "id", "user_id", "metric_id", "day_key", "sum_normalized", "count", "min_normalized", "max_normalized", "avg_normalized", "previous_day_sum", "created_at", "updated_at" FROM `tracker_daily_aggregates`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_tracker_entries`("id", "user_id", "metric_id", "value", "value_normalized", "unit", "notes", "source", "day_key", "recorded_at", "display_value", "raw_input", "meta", "created_at", "updated_at") SELECT "id", "user_id", "metric_id", "value", "value_normalized", "unit", "notes", "source", "day_key", "recorded_at", "display_value", "raw_input", "meta", "created_at", "updated_at" FROM `tracker_entries`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_tracker_metrics`("id", "user_id", "slug", "name", "input_type", "behavior", "unit", "canonical_unit", "conversion_factor", "default_target", "color", "icon", "deleted_at", "order_index", "created_at", "updated_at") SELECT "id", "user_id", "slug", "name", "input_type", "behavior", "unit", "canonical_unit", "conversion_factor", "default_target", "color", "icon", "deleted_at", "order_index", "created_at", "updated_at" FROM `tracker_metrics`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_tracker_quick_actions`("id", "metric_id", "label", "value", "value_normalized", "icon", "position", "created_at", "updated_at") SELECT "id", "metric_id", "label", "value", "value_normalized", "icon", "position", "created_at", "updated_at" FROM `tracker_quick_actions`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_workout_blocks`("id", "user_id", "workout_session_id", "original_block_id", "type", "order_index", "name", "rest_time_seconds", "rest_between_exercises_seconds", "was_added_during_workout", "created_at", "updated_at") SELECT "id", "user_id", "workout_session_id", "original_block_id", "type", "order_index", "name", "rest_time_seconds", "rest_between_exercises_seconds", "was_added_during_workout", "created_at", "updated_at" FROM `workout_blocks`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_workout_sessions`("id", "user_id", "routine_id", "started_at", "finished_at", "total_duration_seconds", "total_sets_planned", "total_sets_completed", "total_volume_kg", "average_rpe", "created_at", "updated_at") SELECT "id", "user_id", "routine_id", "started_at", "finished_at", "total_duration_seconds", "total_sets_planned", "total_sets_completed", "total_volume_kg", "average_rpe", "created_at", "updated_at" FROM `workout_sessions`;--> statement-breakpoint
...
ALTER TABLE `exercise_images` ADD `order_index` integer NOT NULL;--> statement-breakpoint
ALTER TABLE `exercise_images` DROP COLUMN `order`;