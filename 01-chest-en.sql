...
VALUES (
  ...
  '[
    ...
    "Position the dumbbells at the sides of your chest, elbows at 45Â° from your body.",
  ...
  '["Lowering dumbbells too far", "Clanking dumbbells together at top", "Losing lower back arch", "Elbows flared out at 90Â°"]'
);
...
VALUES (
  ...
  '["Too much incline (over 45Â°)", "Lowering bar to neck instead of upper chest", "Lifting glutes off bench"]'
);
...
VALUES (
  ...
  '[
    ...
    "Position the dumbbells at the sides of your upper chest, elbows at 45Â°.",
    "Push the dumbbells up until your arms are extended.",
    "Lower in a controlled manner until your elbows are at bench level.",
...
VALUES (
  ...
  '[
    ...
    "Push the dumbbells up until your arms are extended.",
    "Lower in a controlled manner keeping elbows at 45Â° from your body.",
...
VALUES (
  ...
  '[
    ...
    "Lower your chest toward the floor by bending your elbows at 45Â° from your body.",
    "Lower until your chest almost touches the floor.",
    "Push up until your arms are fully extended.",
    "Keep your core engaged and glutes tight throughout the movement."
  ]',
  '["Sagging or elevated hips", "Elbows flared at 90Â°", "Not going low enough", "Head dropping"]'
);
...
VALUES (
  ...
  '[
    ...
    "Keep your elbows at 45Â° from your body during the descent.",
    "Push up until your arms are extended.",
...
VALUES (
  ...
  '[
    ...
    "Lean your torso forward (about 30Â°) to emphasize the chest.",
    "Cross your feet behind and slightly bend your knees.",
    "Lower your body by bending your elbows until your arms form 90Â° or less.",
