...
BEGIN
  ...
  LOOP
    INSERT INTO workout_blocks (
      id, user_id, workout_session_id, original_block_id,
      ...
      (v_block_item->>'user_id')::uuid,
      v_session_id,
      CASE WHEN v_block_item->>'original_block_id' IS NOT NULL AND v_block_item->>'original_block_id' != 'null'
        THEN (v_block_item->>'original_block_id')::uuid ELSE NULL END,
      v_block_item->>'type',
      (v_block_item->>'order_index')::integer,
      v_block_item->>'name',
      (v_block_item->>'rest_time_seconds')::integer,
  ...
  LOOP
    INSERT INTO workout_exercises (
      ...
      original_exercise_in_block_id, order_index, execution_order,
      ...
      (v_exercise_item->>'exercise_id')::uuid,
      CASE WHEN v_exercise_item->>'original_exercise_in_block_id' IS NOT NULL AND v_exercise_item->>'original_exercise_in_block_id' != 'null'
        THEN (v_exercise_item->>'original_exercise_in_block_id')::uuid ELSE NULL END,
      (v_exercise_item->>'order_index')::integer,
  ...
  LOOP
    INSERT INTO workout_sets (
      id, user_id, workout_exercise_id, exercise_id, original_set_id,
      ...
      CASE WHEN v_set_item->>'original_set_id' IS NOT NULL AND v_set_item->>'original_set_id' != 'null'
        THEN (v_set_item->>'original_set_id')::uuid ELSE NULL END,
      (v_set_item->>'order_index')::integer,
      v_set_item->>'measurement_template',
